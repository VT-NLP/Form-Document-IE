...
class XfunReTrainer(FunsdTrainer):
    def __init__(self, **kwargs):
        ...
        self.label_names.append("region_ids")
    ...
    def prediction_loop(
        ...
        ###############get predictions bounding box/line for visualization################
        gt_relations = []
        gt_line = []
        pred_line = []
        for b in range(len(re_labels)):
            ...
            for head, tail in zip(re_labels[b]["head"], re_labels[b]["tail"]):
                ...
                #head entitiy bbox
                head_bbox = entities[b]["bbox"][rel["head_id"]]
                ...
                #tail entity bbox
                tail_bbox = entities[b]["bbox"][rel["tail_id"]]

                rel["type"] = 1

                rel_sent.append(rel)
                line_sent.append([(head_bbox[0], head_bbox[3]), (head_bbox[2], head_bbox[3]), (tail_bbox[0], tail_bbox[3]), (tail_bbox[2], tail_bbox[3])])
            ...
            for rel_no in range(len(pred_relations[b])):
                ...
                if "bbox" in entities[b]:
                    head_bbox = entities[b]["bbox"][rel["head_id"]]
                    tail_bbox = entities[b]["bbox"][rel["tail_id"]]
                    pred_line_sent.append([(head_bbox[0], head_bbox[3]), (head_bbox[2], head_bbox[3]), (tail_bbox[0], tail_bbox[3]), (tail_bbox[2], tail_bbox[3])])
        ...
        if metric_key_prefix == "eval":
            error_dict['id'] = self.eval_dataset['id']
        error_file = open("/home/pritika/workspace/Data/inference/prediction_viz.json",'w')
