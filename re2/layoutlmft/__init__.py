...
from .models.layoutlmv2 import (
    LayoutLMv2Config,
    LayoutLMv2ForRelationExtractionWithEGAT,
...
from .models.layoutxlm import (
    LayoutXLMConfig,
    LayoutXLMForRelationExtractionWithEGAT,
...
MODEL_FOR_RELATION_EXTRACTION_MAPPING = OrderedDict(
    [(LayoutLMv2Config, LayoutLMv2ForRelationExtractionWithEGAT), (LayoutXLMConfig, LayoutXLMForRelationExtractionWithEGAT)]
)
