...
from ..layoutlmv2 import LayoutLMv2ForRelationExtraction, LayoutLMv2ForTokenClassification, LayoutLMv2Model, LayoutLMv2ForRelationExtractionWithEGAT
...
class LayoutXLMForRelationExtractionWithEGAT(LayoutLMv2ForRelationExtractionWithEGAT):
    config_class = LayoutXLMConfig
